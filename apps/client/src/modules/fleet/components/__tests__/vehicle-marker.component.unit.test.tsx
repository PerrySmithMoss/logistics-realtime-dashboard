...
import { getVehicleMarkerStyles, VehicleMarker } from "../vehicle-marker.component";
...
describe("VehicleMarker", () => {
  ...
  it("renders the active marker tone", () => {
    ...
    expect(screen.getByRole("img", { name: "VHC-101 active vehicle marker" })).toHaveClass(
      getVehicleMarkerStyles("active"),
    );
  });
});

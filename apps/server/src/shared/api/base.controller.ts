...
type ResponseMeta = Omit<Partial<ApiResponseMeta>, "requestId" | "timestamp" | "pagination">;
...
export abstract class BaseController {
  ...
  public ok<T extends SerialisableApiResponseTypes>(
    ...
    return res.status(200).json(createSuccessResponse(data, context, this.responseOptions));
  }
  ...
  public created<T extends SerialisableApiResponseTypes>(
    ...
    return res.status(201).json(createSuccessResponse(data, context, this.responseOptions));
  }
